...
import type { AsterAggTrade } from '@/lib/aster-hooks';

interface Props {
  mode: TradeMode;
  market: string;
  trades: Trade[];
  asterTrades?: AsterAggTrade[];
}

// Live trades column — verbatim structure from index.html + renderTrades().
export function TradesColumn({ mode, market, trades, asterTrades = [] }: Props) {
